...
def build_system_prompt(*, certification_name: str, doc_source_name: str) -> str:
    return (
        ...
        "Si el contenido fuente menciona un servicio de nube especifico de un proveedor "
        "(ej. Amazon S3, Azure Data Lake Storage, Google Cloud Storage, IAM roles de AWS) y el "
        "objetivo del exam guide no pide explicitamente conocimiento de un proveedor de nube en "
        "particular, generaliza usando terminologia neutral (ej. 'cloud object storage', "
        "'almacenamiento de objetos en la nube', 'credenciales de acceso al storage') en vez de "
        "nombrar el proveedor especifico. "
